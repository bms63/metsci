...
- `.github/workflows/refresh-events.yml` scrapes weekly (Mondays), runs on pull requests, and commits refreshed scrape outputs (`data/events.json` and `raw-data/events.csv`).
